...
<div class="structure">
    ...
    <button class="btn-hollow" on:click={() => location.reload()}>
        Ny pakke
    </button>

   <div bind:this={starterPack}>
        <div class="w-60 h-80 rounded cursor-pointer bg-secondary-color-light hover:bg-secondary-color active:bg-secondary-color-dark active:scale-[98%] grid items-center justify-center">
