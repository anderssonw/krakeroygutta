		...
		<div class="w-full bg-primary-color laptop:rounded-lg p-4 tablet:p-8 flex flex-col gap-8">
			<div class="flex flex-row justify-between px-0 mobile:px-4 tablet:px-16">
				<div class="flex flex-col items-center gap-2">
					...
					<div class="text-5xl">{matches.length}</div>
			...
			<div class="w-full rounded text-primary-color-dark border border-tertiary-color-dark">
				<div class="bg-tertiary-color-light rounded-t grid grid-cols-8 border-t border-x border-primary-color-light">
					...
					<div class="border-b border-r border-primary-color-light flex items-center p-1 mobile:p-2 tablet:p-4"><img class={'w-8'} src={fieldIcon} alt="kamper" /></div>
					<div class="border-b border-r border-primary-color-light flex items-center p-1 mobile:p-2 tablet:p-4"><img class={'w-8'} src={winIcon} alt="seiere" /></div>
					<div class="border-b border-r border-primary-color-light flex items-center p-1 mobile:p-2 tablet:p-4"><img class={'w-8'} src={cleanIcon} alt="clean" /></div>
					<div class="border-b border-r border-primary-color-light flex items-center p-1 mobile:p-2 tablet:p-4"><img class={'w-8'} src={goalIcon} alt="mål" /></div>
