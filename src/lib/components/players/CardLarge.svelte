...
<div class="large-card group" on:mouseup={() => goto(`/players/${player.pid}`)}>
    ...
    <div class="w-full absolute top-[79%] right-[20%]">
        <p class="text-center text-primary-color text-xl">50 DEF</p>
    </div>
    <div class="w-full absolute top-[69%] left-[20%]">
        <p class="text-center text-primary-color text-xl">50 PHY</p>
    </div>
    <div class="w-full absolute top-[79%] left-[22%]">
        <p class="text-center text-primary-color text-xl">50 MOR</p>
    </div>
</div>