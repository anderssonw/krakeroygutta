...
<div 
    class="w-10/12 tablet:w-5/12 flex flex-col items-center grow group 
    ...
    <img src="/index/{image}" alt="players" class="w-[80%] mb-2 group-hover:scale-105 group-active:scale-100" />
