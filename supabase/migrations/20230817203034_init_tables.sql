create table "public"."fantasy_team" (
    ...
    "captain_id" bigint not null default '-1'::bigint,
...
create table "public"."matches" (
    ...
    "goals_player_ids" bigint[] not null default '{}'::bigint[],
    "assists_player_ids" bigint[] not null default '{}'::bigint[],
    "clutches_player_ids" bigint[] not null default '{}'::bigint[]
);
...
CREATE UNIQUE INDEX fantasy_team_pkey ON public.fantasy_team USING btree (id);

CREATE UNIQUE INDEX fantasy_teams_players_pkey ON public.fantasy_teams_players USING btree (id);
...
alter table "public"."fantasy_team" add constraint "fantasy_team_user_id_fkey" FOREIGN KEY (user_id) REFERENCES users(id) not valid;

alter table "public"."fantasy_team" validate constraint "fantasy_team_user_id_fkey";

alter table "public"."fantasy_teams_players" add constraint "fantasy_teams_players_fantasy_team_id_fkey" FOREIGN KEY (fantasy_team_id) REFERENCES fantasy_team(id) not valid;
