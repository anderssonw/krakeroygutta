...
alter table "public"."bets_against" add constraint "bets_against_challenger_fkey" FOREIGN KEY (challenger) REFERENCES users(id) not valid;

alter table "public"."bets_against" validate constraint "bets_against_challenger_fkey";

alter table "public"."bets_against" add constraint "bets_against_owner_fkey" FOREIGN KEY (owner) REFERENCES bets(id) not valid;

alter table "public"."bets_against" validate constraint "bets_against_owner_fkey";
